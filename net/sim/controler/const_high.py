...
import numpy as np
import load_trace
import ../frame_2/panoramic_env as env
import datetime
...
# TEST_TRACES = '../test/'
TEST_TRACES = '../../mahimahi_test/trace/const/'
...
# net_info:start_time, end_time, delay, frames_size, queue_length, latency
# video_info:待定
...
def main():
    ...
    all_cooked_time, all_file_names = load_trace.load_trace(TEST_TRACES)
    net_env = env.panoramic_env(all_cooked_time=all_cooked_time)
    video_count = 0
